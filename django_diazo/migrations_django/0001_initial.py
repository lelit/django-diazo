    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pattern', models.CharField(default='.*', help_text='Select this theme when this pattern matches the requested url.', max_length=255, verbose_name='Pattern')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow', models.CharField(help_text='Allow or deny loading this theme when the pattern matches.', max_length=10, verbose_name='Allow or deny', choices=[('allow', 'Allow'), ('deny', 'Deny')])),
