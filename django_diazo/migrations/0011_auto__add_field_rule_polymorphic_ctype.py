...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rule.polymorphic_ctype'
        db.add_column(u'django_diazo_rule', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_django_diazo.rule_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rule.polymorphic_ctype'
        db.delete_column(u'django_diazo_rule', 'polymorphic_ctype_id')
